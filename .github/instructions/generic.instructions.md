...
- **Test Coverage**: Missing tests for critical paths or new functionality, if there is a test suite present. Otherwise recommend them
...
- DRY (Don't Repeat Yourself): no code duplication for algorithms
...
- **Function Docs**: Each function and class/interface should be documented using the language standard
...
| Backend | Supabase (Postgres + RLS) | 2.x |
| Backend functions | Python | 3.12.x |
